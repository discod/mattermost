...
type Store struct {
	...
	// ContentFlaggingStore            mocks.ContentFlaggingStore  // Disabled due to compilation issues with ReviewerIDsSettings
}
...
// func (s *Store) ContentFlagging() store.ContentFlaggingStore {  // Disabled due to compilation issues with ReviewerIDsSettings
...
func (s *Store) AssertExpectations(t mock.TestingT) bool {
	return mock.AssertExpectationsForObjects(t,
		...
		&s.AttributesStore,
		// &s.ContentFlaggingStore,  // Disabled due to compilation issues with ReviewerIDsSettings
	)
}
